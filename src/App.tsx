...
const achievements = [
  ...
  },
  {
    ...
    icon: Layers3,
    color: C.orange,
    kpis: [["OK", "Sistema diseñado"], ["OK", "Señalización"], ["0%", "Pallets capturados"], ["80%", "Avance"]],
  ...
  {
    id: "09",
    title: "Auditoría AT&T",
    short: "Auditoría",
    subtitle: "Validación física y documental de inventario",
    value: 100,
    icon: ShieldCheck,
    color: C.orange,
    kpis: [
    ...
    details: [
      "AT&T realizó auditoría física y documental",
      "No se detectaron faltantes de material",
      "Inventario validado al 100%",
      "Pendiente corrección de folios de material de mudanza",
    ],
    ops: [
      "Material conciliado correctamente",
      "Ubicaciones verificadas físicamente",
    ],
    admin: [
      "Auditoría cerrada satisfactoriamente",
      "Pendientes únicamente folios de mudanza",
    ],
    risks: [
      "Folios pendientes por corregir",
      "Mantener actualización continua del inventario",
    ],
    next: [
      "Corregir folios solicitados por AT&T",
